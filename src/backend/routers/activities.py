...
def get_activities(
    ...
    """
    Get all activities with their details, with optional filtering by day, time, and difficulty level
    ...
    if difficulty_level:
        if difficulty_level == "All":
            # "All" means show only activities with NO difficulty_level specified
